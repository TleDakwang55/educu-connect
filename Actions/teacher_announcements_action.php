...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['action'])) {
        ...
        if (!$conn) {
            ...
            header("Location: ../admin/teacher_dashboard.php?page=create_announcement");
            exit();
        }
        ...
        switch ($action) {
            case 'add':
                ...
                // Get data from the form (from teacher_manage_announcements.php)
            ...
            case 'delete':
                ...
                // Get the announcement ID from the form (from teacher_manage_announcements.php table)
